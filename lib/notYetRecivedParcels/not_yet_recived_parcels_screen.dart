...
class NotYetRecivedParcelsScreen extends StatefulWidget {
  const NotYetRecivedParcelsScreen({super.key});

  @override
  State<NotYetRecivedParcelsScreen> createState() => _OrdersScreenState();
}

class _OrdersScreenState extends State<NotYetRecivedParcelsScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          "Not Yet Recived Parcels Screen",
          style: TextStyle(
            fontSize: 20,
